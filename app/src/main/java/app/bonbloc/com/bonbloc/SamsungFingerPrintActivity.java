...
public class SamsungFingerPrintActivity extends Activity implements Handler.Callback {
    ...
    private SpassFingerprint.IdentifyListener mIdentifyListener = new SpassFingerprint.IdentifyListener() {
        ...
        public void onFinished(int eventStatus) {
            ...
            if (eventStatus == SpassFingerprint.STATUS_AUTHENTIFICATION_SUCCESS) {
                ...
                findViewById(R.id.btn_fingerprintsucess).setVisibility(View.VISIBLE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_samsungfinger);
        nextButton = (Button) findViewById(R.id.btn_fingernext);
        nextButton.setVisibility(View.GONE);
        findViewById(R.id.btn_fingerprintsucess).setVisibility(View.GONE);
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), FingerConsentActivity.class);
